...
//			hibernateConf.buildSessionFactory();// 注解方式必须的
			LocalSessionFactoryBean localSessionFactoryBean = (LocalSessionFactoryBean) SpringBeanUtils.getBean( "&sessionFactory" );
			hibernateConf = localSessionFactoryBean.getConfiguration();
		}
