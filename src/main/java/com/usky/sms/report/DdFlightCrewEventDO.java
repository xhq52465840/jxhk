 ...
 */
@Entity
@Table(name = "QAR_FLIGHT_CREW_EVENT_DD")
@IdClass(FlightCrewEventId.class)
@Comment("运行网 部门飞行小时数")
public class DdFlightCrewEventDO implements Serializable {

	private static final long serialVersionUID = 4067900863536879817L;
