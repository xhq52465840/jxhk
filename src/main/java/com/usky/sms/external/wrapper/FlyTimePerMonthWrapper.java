...
public class FlyTimePerMonthWrapper {
	...
	public static Map<String, Double> wrapFromMaps(List<Map<String, Object>> maps) {
		...
		if (maps != null) {
			for (Map<String, Object> map : maps) {
				if (map.get("flight_month") != null) {
					String date = DateHelper.formatDate(DateHelper.parseDate((String) map.get("flight_month"), "yyyyMM"), "yyyy-MM");
