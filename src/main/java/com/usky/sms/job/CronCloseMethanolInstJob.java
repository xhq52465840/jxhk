 ...
 *
 */
public class CronCloseMethanolInstJob implements Job {
	
	private static final Logger log = Logger.getLogger(CronCloseMethanolInstJob.class);
	...
	public static void setTimestamp(String timestamp) {
		CronCloseMethanolInstJob.timestamp = timestamp;
	}
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		if (errorCount == null || errorCount < DEFAULT_RETRY_TIME) {
			...
			try {
				...
				methanolInstDao.closeMethanolInst();
			} catch (Exception e) {
				e.printStackTrace();
