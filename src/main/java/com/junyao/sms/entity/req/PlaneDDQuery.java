...
/**
 * 
 * <p>PlaneDDQuery complex type�� Java �ࡣ
 * 
 * 
 * <pre>
 * &lt;complexType name="PlaneDDQuery"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="ddNo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "PlaneDDQuery", propOrder = {
    "acno",
    "dateBegin",
    "dateEnd",
    "ddNo",
...
public class PlaneDDQuery {
    ...
    @XmlElementRef(name = "ddNo", namespace = "http://req.entity.sms.junyao.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ddNo;
     ...
     *     
     */
    public JAXBElement<String> getDdNo() {
        return ddNo;
    }
     ...
     *     
     */
    public void setDdNo(JAXBElement<String> value) {
        this.ddNo = value;
    }
