//@ sourceURL=com.audit.query.reportquery.reportsheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.query.reportquery.reportsheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.query.reportquery.reportsheetindex.i18n;
...
//    	
    	...
    	this._ajax("reportfilter.json", {}, this.$, {}, this.proxy(function(result){
    ...
    on_btn_more:function(e){
		...
		moreRenderClazz = $.u.load("com.audit.plugin.reportquery.moreProp");
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
					...
					rulecache.push([{"key":"planType","op":"in","value":["SYS"]}]);
					rulecache.push([{"key":"generateReportDate","op":"is not null","value":""}]);
                	...
                	/*	"columns":JSON.stringify([{"data":"orderNo"}]),
                		...
                		"columns":JSON.stringify([{"data":array_e[0]}]),
                 		...
                 		if(response.data){
                 			/*var responsedata = $.grep(response.data.aaData,this.proxy(function(item,idx){
                 				return $.inArray(parseInt(item.target.targetId),this.targetIDdata) > -1;
                 			}))*/;
                        	...
                        	callback({//?callback?
                        		...
                        		"data":response.data.aaData||responsedata
                        	});
                    	}else{
...
com.audit.query.reportquery.reportsheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.query.reportquery.reportsheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
