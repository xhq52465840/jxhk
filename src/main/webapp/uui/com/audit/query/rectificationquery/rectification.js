//@ sourceURL=com.audit.query.rectificationquery.rectification
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.query.rectificationquery.rectification', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.query.rectificationquery.rectification.i18n;
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
                	...
                	rulecache.push([{"key":"task.planType","op":"in","value":["SYS"]}]);
...
com.audit.query.rectificationquery.rectification.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.query.rectificationquery.rectification.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
