//@ sourceURL=com.audit.secondaryquery.workquery.worksheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.secondaryquery.workquery.worksheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.secondaryquery.workquery.worksheetindex.i18n;
    	...
    	this._ajax("worksheetfilter.json", {}, this.$, {}, this.proxy(function(result){
    ...
    on_btn_more:function(e){
		...
		moreRenderClazz = $.u.load("com.audit.plugin.workquery.moreProp");
          ...
          this.dataTable=this.qid("viewtable").dataTable({
                ...
                "ajax": this.proxy(function (data, callback, settings) {
                	...
                	$.each(querya,this.proxy(function(idx,item){
	                	...
	                	querys.length!=0 && queryc.push({"key":'target',"op":"in","value":querys});
                	}));
                	...
                	/*if(queryd.length==0){
                		//rulecache.push([{"key":"target","op":"in","value":[null]}]);
						 rulecache.push([{"key":"planType","value":"SUB2"}]);
					}*/
...
com.audit.secondaryquery.workquery.worksheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.secondaryquery.workquery.worksheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
