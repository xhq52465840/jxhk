//@ sourceURL=com.audit.plugin.rectificationquery.queryNameProp
$.u.define("com.audit.plugin.rectificationquery.queryNameProp", "com.sms.plugin.search.baseprop", {
    // table段
	//copy form com.sms.plugin.render.summaryProp
	//整改单名称
    table_html: function (data, type,row) { 
    //	http://localhost:8080/sms/uui/com/audit/xitong_jihua/Xitong_jihua_zhenggaifankui.html?id=8384905&isDividedByProfession=false
    	return "<span><a href='" + this.getabsurl("../../xitong_jihua/Xitong_jihua_zhenggaifankui.html?id=" + row.id+"&isDividedByProfession=false&isTransmitted=false") + "' target='_top'>" + (data || "") + "</a></span>"; 
    },
