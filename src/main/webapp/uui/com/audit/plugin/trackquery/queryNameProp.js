//@ sourceURL=com.audit.plugin.trackquery.queryNameProp
$.u.define("com.audit.plugin.trackquery.queryNameProp", "com.sms.plugin.search.baseprop", {
    // table段
    ...
    //	http://localhost:8080/sms/uui/com/audit/xitong_jihua/Xitong_jihua_zhenggaifankui.html?id=8384905&isDividedByProfession=false
    	return "<span><a href='" + this.getabsurl("../../tracklist/TrackList.html?id=" + row.id) + "' target='_top'>" + (data || "") + "</a></span>"; 
    },
