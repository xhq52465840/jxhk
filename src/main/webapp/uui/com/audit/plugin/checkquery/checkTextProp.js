//@ sourceURL=com.audit.plugin.checkquery.checkTextProp
$.u.define("com.audit.plugin.checkquery.checkTextProp", "com.sms.plugin.search.baseprop",{
    // filter段
	//
    ...
    table_html: function (data, type, row, meta) {
		...
		return  '<span style="padding-left:15px;">'+(data?data:"")+'</span>';
	},
