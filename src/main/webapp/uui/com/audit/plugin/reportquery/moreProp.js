//@ sourceURL=com.audit.plugin.reportquery.moreProp
$.u.define("com.audit.plugin.reportquery.moreProp", "com.sms.plugin.search.baseprop",{
    ...
    _loadData:function(){
    	...
    	this._ajax("reportfilter.json", {}, this.$, {}, this.proxy(function(result){
    		...
    		$.each(	this._moreFilter,this.proxy(function(idx,item){
