//@ sourceURL=com.audit.plugin.workquery.queryTextProp
$.u.define("com.audit.plugin.workquery.queryTextProp", "com.sms.plugin.search.baseprop",{
    // filter段
	//
	
    table_html: function (data, type, row, meta) {
    	if(data && data.hasOwnProperty("targetName")){
