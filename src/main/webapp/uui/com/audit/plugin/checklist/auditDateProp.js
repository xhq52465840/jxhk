//@ sourceURL=com.audit.plugin.checklist.auditDateProp
$.u.define("com.audit.plugin.checklist.auditDateProp", "com.sms.plugin.search.baseprop",{
   ...
   table_html: function (data, type, row, meta) {
    ...
    filter_html: function () { 
    	return  '<div class="filter-layer">'
			    + '<form style="min-width:370px; height:270px;" class="form-inline" role="form" id="'+this._id+'-form">'
...
//    	setting = [{"id":"inRangeRadio", "name":"-3w 4d 12h;8w 4d 12h"}];
        ...
        this.i18n = com.audit.plugin.checklist.auditDateProp.i18n;
