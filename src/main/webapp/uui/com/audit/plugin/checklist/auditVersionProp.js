//@ sourceURL=com.audit.plugin.checklist.auditVersionProp
$.u.define("com.audit.plugin.checklist.auditVersionProp", "com.sms.plugin.search.baseprop",{
    ...
    filter_html: function () { 
    	return  '<div class="filter-layer">'
				...
				+ 				'<input type="text" placeholder="查找版本..."  class="form-control input-sm" id="'+this._id+'-search"/>'			
				+ 				'<span class="glyphicon glyphicon-search form-control-feedback removeads" style="cursor:pointer;"></span>'			
				+ 			'</div>'		
			    + 		'</div>'
				+ 		'<div style="max-height: 170px;overflow-y: auto;overflow-x: hidden;clear: both;">'	
