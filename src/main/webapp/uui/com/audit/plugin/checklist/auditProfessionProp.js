//@ sourceURL=com.audit.plugin.checklist.auditProfessionProp
$.u.define("com.audit.plugin.checklist.auditProfessionProp", "com.sms.plugin.search.baseprop",{
    // filter段
    filter_html: function () { 
    	return  '<div class="filter-layer">'
				...
				+ 				'<span class="glyphicon glyphicon-search form-control-feedback removeads auditProfessionProp-search " style="cursor:pointer;"></span>'			
				+ 			'</div>'		
			    + 		'</div>'
