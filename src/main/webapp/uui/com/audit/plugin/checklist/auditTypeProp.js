//@ sourceURL=com.audit.plugin.checklist.auditTypeProp
$.u.define("com.audit.plugin.checklist.auditTypeProp", "com.sms.plugin.search.baseprop",{
    ...
    _loadData:function(){
    	...
    	$.u.ajax({
        	...
        	if (response.success) {        		
        		...
        		this.filter_type(this.dataArray);
