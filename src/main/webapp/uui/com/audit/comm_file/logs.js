...
$.u.load("com.audit.comm_file.remark");
$.u.load("com.audit.comm_file.workflowlog");
$.u.define('com.audit.comm_file.logs', null, {
    ...
    afterrender: function (bodystr) {
    	...
    	this.activityLog = new com.audit.comm_file.activitylog(this.$.find("div[umid='log']"),{
    		"title": "日志",
    		"count": "10",
    		"manual": true, 
    	...
    	this.remarkList = new com.audit.comm_file.remark(this.$.find("div[umid=component]"),{
    		"rule": this._options.remarkRule
        });
    	this.workflowLog = new com.audit.comm_file.workflowlog(this.$.find("div[umid=workflowlog]"),{data:this._options.workflowLogs});
    ...
    on_togglePanel_click: function(e){
        ...
        this.qid("panel-body").slideToggle(600);
    },
    /**
     * @title 选项卡点击事件
     * @param e {object} 鼠标对象
...
com.audit.comm_file.logs.widgetjs = ["../../../uui/widget/jqurl/jqurl.js",
                                      "../../../uui/widget/spin/spin.js", 
                                      "../../../uui/widget/jqblockui/jquery.blockUI.js",
                                      "../../../uui/widget/ajax/layoutajax.js"
                                      ];
com.audit.comm_file.logs.widgetcss = [];