//@ sourceURL=com.audit.innerquery.reportquery.queryNameProp
$.u.define("com.audit.innerquery.reportquery.queryNameProp", "com.sms.plugin.search.baseprop", {
    // table段
	//copy form com.sms.plugin.render.summaryProp
	//审计报告名称
    table_html: function (data, type,row) { 
    	return "<span><a href='" + this.getabsurl("../../innerAudit/xitong_jihua/AuditReport.html?id=" + row.id) + "' target='_top'>" + (data || "") + "</a></span>"; 
    },
