//@ sourceURL=com.audit.innerquery.workquery.worksheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.innerquery.workquery.worksheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.innerquery.workquery.worksheetindex.i18n;
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
                ...
                "ajax": this.proxy(function (data, callback, settings) {
				   ...
				   rulecache.push([{"key":"planType","op":"in","value":["SUB2"]}]);
...
com.audit.innerquery.workquery.worksheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.innerquery.workquery.worksheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
