//@ sourceURL=com.audit.worklist.checklist
$.u.define('com.audit.worklist.checklist', null, {
        ...
        if (data) {
            if (!$.fn.DataTable.isDataTable(this.qid("datatable"))) {
                ...
                var columnsDefs = [{
                    ...
                    "aTargets": 3,
                    "mRender": this.proxy(function(data, type, full) {
                        //return this._showMinusButton ? "<span data-id='" + data + "' class='uui-cursor-pointer del'><img src='../img/delete.png'></span>" : "";
    ...
    modifyRow: function(e) {
        ...
        if (data) {
            if (!this.recordDiForm) {
                ...
                this.recordDiForm = new com.audit.worklist.dialog($("div[umid='recordDiForm']", this.$), {
...
com.audit.worklist.checklist.widgetjs = ["../../../uui/widget/select2/js/select2.min.js",
...
com.audit.worklist.checklist.widgetcss = [{
