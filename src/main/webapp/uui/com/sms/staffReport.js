  ...
  var staffReportWidget = {
    ...
    _getFormData: function(){
    	/*var val=$("#description").val();
		   ...
		   var mval=$("#hopeMeasure").val();
		   mval=mval.replace(/\n/g,'<br>');
		   $("#hopeMeasure").val(mval);*/
    ...
    _on_description:function(){
    	if($("#description").val().length >=1990) {
    		$("#description").val($("#description").val().substr(0,1990));	    
  	  }
    },
    /**
     * @title 提交
    ...
    _on_submit_click: function(e){
      ...
      var option = {
		      ...
		      if (mthis.validated()&&$("form:first").valid()&& mode) {
		        var param = {
		          method: "submitEmReport",
