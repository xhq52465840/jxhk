//@ sourceURL=com.sms.plugin.riskAnalysis.riskAnalyseActivityType
$.u.define('com.sms.plugin.riskAnalysis.riskAnalyseActivityType', null, {
    ...
    afterrender: function (bodystr) {
        this.i18n = com.sms.plugin.riskAnalysis.riskAnalyseActivityType.i18n;
        ...
        this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function (aoData) {
                $.extend(aoData,{
                    ...
                    "dataobject": "systemAnalysisRiskAnalysisActivityTypeEntity",
    ...
    on_addActivityType_click:function(e){
        if(this.riskAnalyseDialog == null){
            this._initActivityTypeDialog();
        }       
        this.riskAnalyseDialog.open();
    },
    /**
     * @title 删除安全信息类型
     * @param e {object} 鼠标对象
    ...
    _initActivityTypeDialog:function(){
        ...
        this.riskAnalyseDialog = new com.sms.common.stdComponentOperate($("div[umid='riskAnalyseDialog']",this.$),{
            "title":com.sms.plugin.riskAnalysis.riskAnalyseActivityType.i18n.addActivityType,
            "dataobject":"systemAnalysisRiskAnalysisActivityTypeEntity",
            "fields":[
        ...
        this.riskAnalyseDialog.override({
            refreshDataTable:this.proxy(function(){
                this.dataTable.fnDraw();
            })
        });
...
com.sms.plugin.riskAnalysis.riskAnalyseActivityType.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
                                               '../../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.plugin.riskAnalysis.riskAnalyseActivityType.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
