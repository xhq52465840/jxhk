//@ sourceURL=com.sms.plugin.render.dictionaryProp
$.u.define("com.sms.plugin.render.dictionaryProp", "com.sms.plugin.render.baseprop", {
    // table段
...
//	    			method: "stdcomponent.getbysearch",
//	    			dataobject: "dictionary",
//	    			rule: JSON.stringify([[{"key":"value", "value"}]])
//	    		}
//	    	});
//    	}
...
com.sms.plugin.render.dictionaryProp.widgetjs = ['../../../../uui/widget/select2/js/select2.min.js'];
com.sms.plugin.render.dictionaryProp.widgetcss = [{id:"",path:"../../../../uui/widget/select2/css/select2.css"},
