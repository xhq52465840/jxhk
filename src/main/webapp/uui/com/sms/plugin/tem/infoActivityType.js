//@ sourceURL=com.sms.plugin.tem.infoActivityType
$.u.define('com.sms.plugin.tem.infoActivityType', null, {
    ...
    afterrender: function (bodystr) {
    	this.i18n = com.sms.plugin.tem.infoActivityType.i18n;
    	...
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function (aoData) {
            	$.extend(aoData,{
            		...
            		"dataobject": "accessInformationActivityTypeEntity",
    ...
    _initActivityTypeDialog:function(){
    	...
    	this.activityTypeDialog = new com.sms.common.stdComponentOperate($("div[umid='activityTypeDialog']",this.$),{
    		"title":com.sms.plugin.tem.infoActivityType.i18n.addActivityType,
    		"dataobject":"accessInformationActivityTypeEntity",
    		"fields":[
...
com.sms.plugin.tem.infoActivityType.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
                                               '../../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.plugin.tem.infoActivityType.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
