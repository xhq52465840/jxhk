...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $ttBox = $("<div>操作提示</div>").addClass("ttBox");//弹窗顶部区域
		var $txtBox = $("<div>").addClass("txtBox");//弹窗内容主体区
		var $btnArea = $("<div></div>").addClass("btnArea");//按钮区域
		
		var $ok = $("<a>").addClass("sgBtn").addClass("ok").text($.cookie('locale') === 'en' ? 'ok' : "确认");//确定按钮
		var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text($.cookie('locale') === 'en' ? 'cancel' : "取消");//取消按钮
