//@ sourceURL=com.sms.system.dictionaryAudit
$.u.define('com.sms.system.dictionaryAudit', null, {
    init: function (options) {
        this._options = options;
    },
    afterrender: function (bodystr) {
    	this.i18n = com.sms.system.dictionaryAudit.i18n;
...
//                { "title": this.i18n.type ,"mData":"type","sWidth":"15%"},
                { "title": this.i18n.key ,"mData":"key","sWidth":"10%"},
            ...
            "fnServerParams": this.proxy(function (aoData) {
            	...
            	if(this.qid("type").val()){
            		...
            		rule.push([{"key":"type", "op":"like", "value":"审计角色"},
            		    {"key":"type", "op":"like", "value":"审计库版本"},
            		    {"key":"type", "op":"like", "value":"现场检查"},
            		    {"key":"type", "op":"like", "value":"审计结论"},
            		    {"key":"type", "op":"like", "value":"审计参数"}
            		]);
            	}
            ...
            "aoColumnDefs": [
                {
                    ...
                    "mRender": function (data, type, full) {
	                	return "<button class='btn btn-link edit' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionaryAudit.i18n.editing+"</button>"+
			             	   "<button class='btn btn-link delete' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionaryAudit.i18n.remove+"</button>";
                    }
                }
            ]
        });
    ...
    _initDictionaryDialog:function(){
    	...
    	this.dictionaryDialog = new com.sms.common.stdComponentOperate($("div[umid='dictionaryDialog']",this.$),{
    		"title":com.sms.system.dictionaryAudit.i18n.addDictionary,
    		"dataobject":"dictionary",
    		"fields":[
...
com.sms.system.dictionaryAudit.widgetjs = ['../../../uui/widget/jqdatatable/js/jquery.dataTables.js', '../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.system.dictionaryAudit.widgetcss = [{ path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' }, { path: '../../../uui/widget/jqdatatable/css/dataTables.bootstrap.css' }];