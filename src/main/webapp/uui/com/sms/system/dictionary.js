//@ sourceURL=com.sms.system.dictionary
$.u.define('com.sms.system.dictionary', null, {
    init: function (options) {
        this._options = options;
    },
    afterrender: function (bodystr) {
    	this.i18n = com.sms.system.dictionary.i18n;
    	...
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "columns": [
                ...
                { "title": this.i18n.type ,"mData":"type","sWidth":"25%"},
            ...
            "aoColumnDefs": [
                {
                    ...
                    "mRender": function (data, type, full) {
	                	return "<button class='btn btn-link edit' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionary.i18n.editing+"</button>"+
			             	   "<button class='btn btn-link delete' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionary.i18n.remove+"</button>";
                    }
                }
            ]
        });
...
com.sms.system.dictionary.widgetjs = ['../../../uui/widget/jqdatatable/js/jquery.dataTables.js', '../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.system.dictionary.widgetcss = [{ path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' }, { path: '../../../uui/widget/jqdatatable/css/dataTables.bootstrap.css' }];