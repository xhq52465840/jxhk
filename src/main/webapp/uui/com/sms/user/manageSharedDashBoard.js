//@ sourceURL=com.sms.user.manageSharedDashBoard
$.u.define('com.sms.user.manageSharedDashBoard', null, {
    init: function () {
    	this._select2PageLength = 10;
    },
    afterrender: function () {
    	this.i18n = com.sms.user.manageSharedDashBoard.i18n;
            ...
            "aoColumnDefs": [{
                ...
                "mRender": function (data, type, full) {
                    ...
                    if (!full.paladin || full.paladin == "") {
                        htm += "<li class='private'>"+com.sms.user.manageSharedDashBoard.i18n.privatePanel+"</li>";
                    } else {
                        if (full.paladin.indexOf("ALL") > -1) {
                            htm += "<li class='public'>"+com.sms.user.manageSharedDashBoard.i18n.shareAll+"</li>";
                        } else {
                            ...
                            $.each(alltypes, function (idx, atype) {
                                ...
                                var tp = typeinfo[0];
                                if (tp != "") {
                                    htm += "<li class='public'><b>" + (tp == "U" ? com.sms.user.manageSharedDashBoard.i18n.user : (tp == "G" ? com.sms.user.manageSharedDashBoard.i18n.userGroup : com.sms.user.manageSharedDashBoard.i18n.unknown)) + "</b>：" + typeinfo[1] + "</li>";
                                }
                            });
                        }
                    }
                    ...
                    "mRender": function (data, type, full) {
                        return "<span class='dropdown operate'><a href='#' class='dropdown-toggle dropdown-toggle-icon' data-toggle='dropdown'><span class='glyphicon glyphicon-cog'></span><b class='caret'></b></a>" +
                        			"<ul class='dropdown-menu pull-right' >" +
                        				"<li><a href='#' class='change' data='" + JSON.stringify(full) + "'>"+com.sms.user.manageSharedDashBoard.i18n.changeOwner+"</a></li>" +
                                        "<li><a href='#' class='delete' data='" + JSON.stringify(full) + "'>"+com.sms.user.manageSharedDashBoard.i18n.removePanel+"</a></li>" +
                        			"</ul>";
                    }
                }
            ]
            ...
            try {
                ...
                if(!this.changedialog){
                	...
                	this.changedialog = new com.sms.common.stdComponentOperate($("div[umid='changedialog']", this.$), {
                        ...
                        fields: [{
                            name: "creator", label: "面板拥有者", type: "select", dataType: "int", rule: { required: true }, message: "拥有者不能为空", option: {
            ...
            try {
                ...
                (new com.sms.common.stdcomponentdelete({
                    body: "<div>" +
        				 ...
        				 "</div>",
                    title: this.i18n.removePanel + boarddata.name,
                    dataobject: "dashboard",
...
com.sms.user.manageSharedDashBoard.widgetjs = ['../../../uui/widget/select2/js/select2.min.js', '../../../uui/widget/jqdatatable/js/jquery.dataTables.js', '../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.user.manageSharedDashBoard.widgetcss = [{ path: "../../../uui/widget/select2/css/select2.css" }, { path: "../../../uui/widget/select2/css/select2-bootstrap.css" }, { path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' }, { path: '../../../uui/widget/jqdatatable/css/dataTables.bootstrap.css' }];
