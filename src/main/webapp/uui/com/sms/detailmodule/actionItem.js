//@ sourceURL=com.sms.detailmodule.actionItem
/**
 * @title 行动项组件
 * @author tchen@usky.com.cn
 * @date 2016/12/01 
 */
$.u.define('com.sms.detailmodule.actionItem', null, {
    init: function(option) {
        ...
        this.i18n = com.sms.detailmodule.actionItem.i18n;
    ...
    on_openUnitDialog_click: function(e) {
        ...
        $("body").unbind("mousedonw").bind("mousedown", this.proxy(function(e) {
            var $this = $(e.target);
    ...
    on_saveActionItem_click: function(e) {
        ...
        obj = {
            ...
            "measure": this.CONTROL_MEASURE_ID,
            "clause": this.CLAUSE_ID
        };
...
com.sms.detailmodule.actionItem.widgetjs = [
...
com.sms.detailmodule.actionItem.widgetcss = [{
    id: "ztreestyle",
