//@ sourceURL=com.audit.filter.moreProp
$.u.define("com.audit.filter.moreProp", "com.sms.plugin.search.baseprop",{
    // filter段
    ...
    _loadData:function(){
    	...
    	$.u.ajax({
        	...
        	if (data.success) {
        		this.moreData = data.data.aaData;
        		this.recentData = [];
        		...
        		//最新字段
        		//将已选中的字段去掉
        		this.recentData && $.each(this.recentData,this.proxy(function(idx,item){
