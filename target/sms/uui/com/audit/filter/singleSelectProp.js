//@ sourceURL=com.audit.filter.singleSelectProp
$.u.define("com.audit.filter.singleSelectProp", "com.sms.plugin.search.baseprop",{
    // filter段
    ...
    filter_render: function (setting,toolsel) {
        ...
        this.statusUl.off("click", ":checkbox").on("click", ":checkbox", this.proxy(function(e){
        	...
        	if($this.is(":checked")){
        		 ...
        		 */
        		/*this.checkedIdArray = [];
        		$this.parents('li').siblings().find(":checked").prop("checked",true);*/
