//@ sourceURL=com.audit.inspection.feedbacksheet
$.u.load("com.audit.filter.filter");
$.u.define('com.audit.inspection.feedbacksheet', null, {
    init: function () {
    	this.staticfilter = [
			{
				"config": {
    ...
    getDisplayFilter : function(){
		...
		module.override({
			loadData:this.proxy(function(param){
				...
				this.searchTerms.push([{"key":"permittedQuery","value":true}]);
				if(this.dataTable){
    ...
    _createTable : function(){
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "sDom":"tip",
            "columns": [
                { "title": "整改反馈单名称" ,"mData":"improveName","sWidth":"20%"},
                { "title": "整改反馈单编号" ,"mData":"improveNo"},
            ...
            "aoColumnDefs": [
                {
                    ...
                    "mRender": function (data, type, full) {
                    	return "<a href='viewReviewFeedBack.html?id="+full.id +"' target='_blank' >" + (data||"") + "</a>";
                    }
                },
                {
                    "aTargets": 1,
...
com.audit.inspection.feedbacksheet.widgetjs = ["../../../uui/widget/jqdatatable/js/jquery.dataTables.js",
                                                 "../../../uui/widget/spin/spin.js", 
                                                 "../../../uui/widget/jqurl/jqurl.js",
                                                 "../../../uui/widget/jqblockui/jquery.blockUI.js",
                                                 "../../../uui/widget/ajax/layoutajax.js"];
com.audit.inspection.feedbacksheet.widgetcss = [{ path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
