//@ sourceURL=com.audit.query.workquery.worksheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.query.workquery.worksheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.query.workquery.worksheetindex.i18n;
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
                	...
                	$.each(querya,this.proxy(function(idx,item){
	                	...
	                	if(item.propvalue){//item={key: "type",propvalue: Array[3]}
	                		$.each(item.propvalue,this.proxy(function(idx,field){
	                			...
	                			}else if(item.key=="workNo"){
	                				querye.push({"key":item.key,"op":"like","value":field.name});
                	...
                	querye.length==0?"":(rulecache.push(querye));
                	if(queryc.length==0){
    ...
    loadFilterByUrl:function(){
    	...
    	if(params.filterId && $.isNumeric(params.filterId)){
        	...
        	},this.qid("result-panel"),{backgroundColor:'#fff',width:"100%"},this.proxy(function(response){
...
com.audit.query.workquery.worksheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.query.workquery.worksheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
