//@ sourceURL=com.audit.query.trackquery.track
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.query.trackquery.track', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.query.trackquery.track.i18n;
    	...
    	this._ajax("trackfilter.json", {}, this.$, {}, this.proxy(function(result){
    ...
    on_btn_more:function(e){
		...
		moreRenderClazz = $.u.load("com.audit.plugin.trackquery.moreProp");
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
                	...
                	rulecache.push([{"key":"task.planType","op":"in","value":["SYS","SUB2","SUB3"]}]);
                	 delete data.order;
                     delete data.draw;
                     delete data.search;
                	 delete data.columns;
...
com.audit.query.trackquery.track.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.query.trackquery.track.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
