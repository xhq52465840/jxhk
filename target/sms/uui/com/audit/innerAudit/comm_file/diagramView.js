//@ sourceURL=com.audit.comm_file.diagramView
$.u.define('com.audit.innerAudit.comm_file.diagramView', null, {
    ...
    afterrender: function (bodystr) {
    	this.diagramViewDialog = $(".diagramview",this.$).dialog({
    		...
    		buttons:[{
    			'text':com.audit.comm_file.diagramView.i18n.close,
...
com.audit.innerAudit.comm_file.diagramView.widgetjs = ['../../../../uui/widget/workflow/raphael-min.js',
...
com.audit.innerAudit.comm_file.diagramView.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' }, { path: '../../../../uui/widget/jqdatatable/css/dataTables.bootstrap.css' }];