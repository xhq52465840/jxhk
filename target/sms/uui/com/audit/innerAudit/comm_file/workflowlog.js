//@ sourceURL=com.audit.innerAudit.comm_file.workflowlog
$.u.define('com.audit.innerAudit.comm_file.workflowlog', null, {
    ...
    _draw:function(){
    	if(this._options.data){
    		...
    		$.each(this._options.data,this.proxy(function(idx,item){
    			...
    			var last_update = item.last_update ? this._formatDate(item.last_update) : "";
...
com.audit.innerAudit.comm_file.workflowlog.widgetjs = ["../../../../uui/widget/spin/spin.js", 
                                             "../../../../uui/widget/jqblockui/jquery.blockUI.js",
                                             "../../../../uui/widget/ajax/layoutajax.js"];
com.audit.innerAudit.comm_file.workflowlog.widgetcss = [];