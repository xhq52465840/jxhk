//@ sourceURL=com.audit.innerAudit.comm_file.remark
$.u.define('com.audit.innerAudit.comm_file.remark', null, {
    init: function (option) {
    	this._options = option; //<a href="'+this.getabsurl("../ViewProfile.html?id=#{userid}")+'">#{username}</a>
    	this.i18n = com.audit.innerAudit.comm_file.remark.i18n;
    ...
    on_edit_click:function(e){
		...
		$.u.load("com.audit.innerAudit.comm_file.remarkDialog");
		this.remarkDialog && this.remarkDialog.destroy && this.remarkDialog.destroy();
    	this.remarkDialog = new com.audit.innerAudit.comm_file.remarkDialog($("div[umid='remarkDialog']",this.$));
    ...
    on_remove_click:function(e){
		...
		try{
    		...
    		$.u.load("com.audit.innerAudit.comm_file.stdcomponentdelete"); 
    		(new com.audit.innerAudit.comm_file.stdcomponentdelete({
    			body:"<div>"+
    				 	"<p>你确定要删除这个备注吗?</p>" +
    ...
    reload: function () {
        $.u.ajax({
            ...
            data: {
        		...
        		"rule":JSON.stringify(this._options.rule)
            }
...
com.audit.innerAudit.comm_file.remark.widgetjs = ["../../../../uui/widget/spin/spin.js", 
                                       "../../../../uui/widget/jqblockui/jquery.blockUI.js",
                                       "../../../../uui/widget/ajax/layoutajax.js"];
com.audit.innerAudit.comm_file.remark.widgetcss = [];