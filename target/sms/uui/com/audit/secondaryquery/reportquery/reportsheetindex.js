//@ sourceURL=com.audit.secondaryquery.reportquery.reportsheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.secondaryquery.reportquery.reportsheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.secondaryquery.reportquery.reportsheetindex.i18n;
        ...
        if ($.fn.DataTable.isDataTable(this.qid("detailtable"))) {
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
					...
					//rulecache.push([{"key":"operator","op":"in","value":this.targetIDdata.length>0?this.targetIDdata:[null]}]);

					rulecache.push([{"key":"planType","value":"SUB3"}]);
...
com.audit.secondaryquery.reportquery.reportsheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.secondaryquery.reportquery.reportsheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
