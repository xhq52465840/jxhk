//@ sourceURL=com.audit.secondaryquery.rectificationquery.rectification
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.secondaryquery.rectificationquery.rectification', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.secondaryquery.rectificationquery.rectification.i18n;
    	...
    	$.u.ajax({
            ...
            data: {
        		...
        		"method": "getOrganizationUseSheet",
    			"type":"SUB3"
        	}
       ...
       /*     
          ...
          this.dataTable=this.qid("viewtable").dataTable({
        		...
        		//	{"method":"stdcomponent.getbysearch", "dataobject":"item",	"rule": JSON.stringify([[{"key":"type","value":null}]])},
                	...
                	rulecache.push([{"key":"task.planType","value":"SUB3"}]);
                ...
                "headerCallback": this.proxy(function( thead, data, start, end, display ) {
                	...
                	$(".results th.field-improveNo").css("min-width","160px");
                })
            });
...
com.audit.secondaryquery.rectificationquery.rectification.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.secondaryquery.rectificationquery.rectification.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
