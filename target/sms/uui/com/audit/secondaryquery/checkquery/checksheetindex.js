//@ sourceURL=com.audit.secondaryquery.checkquery.checksheetindex
$.u.load("com.sms.common.stdcomponentdelete");
$.u.define('com.audit.secondaryquery.checkquery.checksheetindex', null, {
    ...
    afterrender: function () {
    	 ...
    	 */
    	this.i18n = com.audit.secondaryquery.checkquery.checksheetindex.i18n;
            				...
            				filter=	propval[0].id;
                       	 	switch(item.key){
                           	  ...
                           	  case "planTime":
                       			  ...
                       			  break;
                    		  case "checkName":
                    			  $.extend(true,queryobj,{"checkName":filter});
                    			  break;
                    		  case "checkNo":
                    			  $.extend(true,queryobj,{"checkNo":filter});
                    			  break;
                    		  case "target":
                    			  $.extend(true,queryobj,{"target":filter});
                    			  break;
                    		  case "address":
                    			  $.extend(true,queryobj,{"address":filter});
                    			  break;
                    		  case "remark":
                    			  $.extend(true,queryobj,{"remark":filter});
                    			  break;
                    		  case "record":
                    			  $.extend(true,queryobj,{"record":filter});
                    			  break;
                    		  case "result":
                    			  $.extend(true,queryobj,{"result":filter});
                    			  break;
                    		  case "flowStatus":
                    			  $.extend(true,queryobj,{"flowStatus":filter});
                    			  break;
                    		}
...
//                	}
                	  ...
                	  $.extend(true,queryobj,{"planType":["SUB3"]});
                	 delete data.order;
                     delete data.draw;
                     delete data.search;
                	delete data.columns;
...
com.audit.secondaryquery.checkquery.checksheetindex.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
...
com.audit.secondaryquery.checkquery.checksheetindex.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
