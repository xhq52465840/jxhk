//@ sourceURL=com.audit.secondaryquery.workquery.queryNameProp
$.u.define("com.audit.secondaryquery.workquery.queryNameProp", "com.sms.plugin.search.baseprop", {
    // table段
	//copy form com.sms.plugin.render.summaryProp
	//工作单名称
    table_html: function (data, type,row) {
    	return "<span><a href='" + this.getabsurl("../../innerAudit/worklist/viewworklist.html?id=" + row.id) + "' target='_top'>" + (data || "") + "</a></span>"; 
    },
