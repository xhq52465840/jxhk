//@ sourceURL=com.audit.dash.subCompany
$.u.define('com.audit.dash.subCompany', null, {
    ...
    initHtml: function(){
		...
		this.year1.add(this.year2).datepicker({ dateFormat: "yy-mm-dd" });
		this.form.validate({
			rules: {
				auditType: "required",
				year1: {
    ...
    _setData : function(data){
		...
		require(['echarts', 'echarts/chart/bar'],
            this.proxy(function (ec) {
            	var	myChart = ec.init(document.getElementById('auditConsub'));
...
com.audit.dash.subCompany.widgetjs = ['../../../uui/widget/select2/js/select2.min.js',
         							  '../../../uui/widget/spin/spin.js',
         							  '../../../uui/widget/jqblockui/jquery.blockUI.js',
         							  '../../../uui/widget/ajax/layoutajax.js',
         							  '../../../uui/widget/validation/jquery.validate.js',
         							  '../../sms/dash/echarts/js/echarts.js'];
com.audit.dash.subCompany.widgetcss = [{id:"",path:"../../../uui/widget/select2/css/select2.css"},
