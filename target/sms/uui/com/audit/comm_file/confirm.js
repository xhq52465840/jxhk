//@ sourceURL=com.audit.comm_file.confirm
$.u.define('com.audit.comm_file.confirm', null, {
    init: function (options) {
	    ...
	    */
        ...
        this._i18n = com.audit.comm_file.confirm.i18n;
        this.confirmDialog = $("<div/>").html(this._options.body || this._i18n.body).dialog({
			...
			open: this.proxy(function(){
				var length = $("body>.ui-dialog").length, zIndex = 0;
				if(length > 4){
					zIndex = $("body>.ui-dialog").eq(length-2).css("z-index");
					$("body>.ui-dialog:last").css("z-index", zIndex + 2);
					$("body>.ui-widget-overlay:last").css("z-index", zIndex + 1);
				}else{
					zIndex = $("body>.ui-dialog:last").css("z-index");
					$("body>.ui-dialog:last").css("z-index", zIndex + 2);
					$("body>.ui-widget-overlay:last").css("z-index", zIndex + 1);
				}
...
com.audit.comm_file.confirm.widgetjs = [];
com.audit.comm_file.confirm.widgetcss = [];