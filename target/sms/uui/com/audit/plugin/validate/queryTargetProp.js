//@ sourceURL=com.audit.plugin.validate.queryTargetProp
$.u.define("com.audit.plugin.validate.queryTargetProp", "com.sms.plugin.search.baseprop",{
    ...
    filter_html: function () { 
    	return  '<div class="filter-layer">'
				...
				+ 				'<input type="text" placeholder="查找责任部门..."  class="form-control input-sm" id="'+this._id+'-search"/>'			
    ...
    _loadData:function(){
    	...
    	$.u.ajax({
            ...
            data: {
        		...
        		//"unitName": term
    			"method":"getOrganizationsByViewUnit",
