// @ sourceURL=com.sms.dash.map
$.u.define('com.sms.dash.map', null, {
	...
	afterrender : function(bodystr) {
		this.setCondition();
		this._getData();
		this.qid("all").click(this.proxy(this._openWin));
		this.qid("search").off("click").on("click",this.proxy(this._search));
	},
	_openWin : function(){
		window.open(window.encodeURI(encodeURI("review_score_and_system_consequence.html?unitId=" + 0 + "&unitName=" + escape("全部"))));
	},
...
com.sms.dash.map.widgetjs = [ '../../../uui/widget/spin/spin.js', 
							  '../../../uui/widget/jqblockui/jquery.blockUI.js',
							  '../../../uui/widget/ajax/layoutajax.js', 
							  'echarts/js/echarts.js', 
							  '../../../uui/widget/jqurl/jqurl.js'];
com.sms.dash.map.widgetcss = [{ path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
