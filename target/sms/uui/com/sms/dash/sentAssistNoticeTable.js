//@ sourceURL=com.sms.dash.sentAssistNoticeTable
$.u.define('com.sms.dash.sentAssistNoticeTable',null, {
	//我发出的协助处理
    ...
    _initDataTable: function(){    	
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "sDom":"rt<ip>",
            "columns": [
                { "title": "主题", "mData":"title", "width":"10%"},
                { "title": "发送人","sClass":"nowrap", "mData":"senderDisplayName", "width":"10%"},
                { "title": "时间","sClass":"nowrap", "mData":"sendTime", "width":120},
                { "title": "安全信息","sClass":"", "mData":"activity", "width":"10%"},
                { "title": "标记","sClass":"nowrap", "mData":"id", "sWidth":80}
            ],
            "oLanguage": { //语言
                "sSearch": "搜索:",
            ...
            "fnServerParams": this.proxy(function (aoData) {
            	...
            	$.extend(aoData,{
            		...
            		"method": "getMessages",
            		"paramType": "getUncheckedMessagesBySender",
            		"sourceType": "ACTIVITY"
            	},true);
            }),
            ...
            "aoColumnDefs": [
				...
				},
                {
                    ...
                    "mRender": function (data, type, full) {
                    	return !full.senderChecked ? "<a href='#' class='editSee' data-id='" + full.id + "' >标记为已阅</a>" : "";
                    }
                }
            ],
    	...
    	try{
    		...
    		this._ajax(
    			...
    			true,
    			{
            		...
            		"dataobjectid": id,
            		"dataobject": "message",
            		"obj":JSON.stringify({senderChecked:true})
    			},
    			this.dataTable,
    			{},
    			this.proxy(function(response){
...
com.sms.dash.sentAssistNoticeTable.widgetjs = ['../../../uui/widget/select2/js/select2.min.js',
                                             '../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
                                             "../../../uui/widget/spin/spin.js", 
                                             "../../../uui/widget/jqblockui/jquery.blockUI.js",
                                             "../../../uui/widget/ajax/layoutajax.js"];
com.sms.dash.sentAssistNoticeTable.widgetcss = [{id:"",path:"../../../uui/widget/select2/css/select2.css"},
