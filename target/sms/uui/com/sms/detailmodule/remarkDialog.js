//@ sourceURL=com.sms.detailmodule.remarkDialog
$.u.define('com.sms.detailmodule.remarkDialog', null, {
    ...
    _fillForm:function(data){
    	this.author.attr("href",this.getabsurl("../ViewProfile.html?id=")+data.userId).text(data.fullname + "(" + data.username + ")");
    	this.createdate.text(data.created);
    	this.remark.val(data.body);
    	if(data.updatedAuthor){
        	this.updateauthor.attr("href",this.getabsurl("../ViewProfile.html?id=")+data.updatedAuthorId).text(data.updatedAuthor);
...
com.sms.detailmodule.remarkDialog.widgetjs = [];
com.sms.detailmodule.remarkDialog.widgetcss = [];