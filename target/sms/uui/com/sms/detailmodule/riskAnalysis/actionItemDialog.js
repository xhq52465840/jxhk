//@ sourceURL=com.sms.detailmodule.riskAnalysis.actionItemDialog
$.u.define('com.sms.detailmodule.riskAnalysis.actionItemDialog', null, {
    init: function(option) {
        this._options = option || {};
        this.TITLE = null; // dialog title    	
    },
    afterrender: function(bodystr) {
        this.i18n = com.sms.detailmodule.riskAnalysis.actionItemDialog.i18n;
    ...
    on_formDialog_create: function() {
        var clz = $.u.load("com.sms.detailmodule.riskAnalysis.actionItem");
...
com.sms.detailmodule.riskAnalysis.actionItemDialog.widgetjs = ['../../../../uui/widget/jqurl/jqurl.js', ];
com.sms.detailmodule.riskAnalysis.actionItemDialog.widgetcss = [];