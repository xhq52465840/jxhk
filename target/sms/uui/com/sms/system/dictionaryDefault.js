//@ sourceURL=com.sms.system.dictionaryDefault
$.u.define('com.sms.system.dictionaryDefault', null, {
    init: function (options) {
        this._options = options;
    },
    afterrender: function (bodystr) {
    	this.i18n = com.sms.system.dictionaryDefault.i18n;
    	...
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function (aoData) {
            	...
            	if(this.qid("type").val()){
            		...
            		rule.push([{"key":"type", "op":"like", "value":"用户缺省设置"}]);
            	}
            ...
            "aoColumnDefs": [
                {
                    ...
                    "mRender": function (data, type, full) {
	                	return "<button class='btn btn-link edit' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionaryDefault.i18n.editing+"</button>"+
			             	   "<button class='btn btn-link delete' data='"+JSON.stringify(full)+"'>"+com.sms.system.dictionaryDefault.i18n.remove+"</button>";
                    }
                }
            ]
        });
    ...
    _initDictionaryDialog:function(){
    	...
    	this.dictionaryDialog = new com.sms.common.stdComponentOperate($("div[umid='dictionaryDialog']",this.$),{
    		"title":com.sms.system.dictionaryDefault.i18n.addDictionary,
    		"dataobject":"dictionary",
    		"fields":[
...
com.sms.system.dictionaryDefault.widgetjs = ['../../../uui/widget/jqdatatable/js/jquery.dataTables.js', '../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.system.dictionaryDefault.widgetcss = [{ path: '../../../uui/widget/jqdatatable/css/jquery.dataTables.css' }, { path: '../../../uui/widget/jqdatatable/css/dataTables.bootstrap.css' }];