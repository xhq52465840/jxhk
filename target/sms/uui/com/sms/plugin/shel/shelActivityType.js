//@ sourceURL=com.sms.plugin.shel.shelActivityType
$.u.define('com.sms.plugin.shel.shelActivityType', null, {
    ...
    afterrender: function(bodystr) {
        this.i18n = com.sms.plugin.shel.shelActivityType.i18n;
        ...
        this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function(aoData) {
                $.extend(aoData, {
                    ...
                    "dataobject": "eventAnalysisActivityTypeEntity",
            ...
            "fnServerData": this.proxy(function(sSource, aoData, fnCallBack, oSettings) {
                $.ajax({
                    ...
                    if (data.success) {
                        this._existActivityTypeArray = $.map(data.data.aaData, function(item, idx) {
                            return item.activityTypeId;
                        });
    ...
    _initActivityTypeDialog: function() {
        ...
        this.activityTypeDialog = new com.sms.common.stdComponentOperate($("div[umid='activityTypeDialog']", this.$), {
            "title": com.sms.plugin.shel.shelActivityType.i18n.addActivityType,
            "dataobject": "eventAnalysisActivityTypeEntity",
            "fields": [{
                name: "activityType",
                ...
                message: this.i18n.activityTypeNotNull,
                option: {
                    params: {
...
com.sms.plugin.shel.shelActivityType.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js', '../../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.plugin.shel.shelActivityType.widgetcss = [{
