//@ sourceURL=com.sms.plugin.riskAnalysis.systemAnalyseActivityType
$.u.define('com.sms.plugin.riskAnalysis.systemAnalyseActivityType', null, {
    ...
    afterrender: function (bodystr) {
        this.i18n = com.sms.plugin.riskAnalysis.systemAnalyseActivityType.i18n;
        ...
        this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function (aoData) {
                $.extend(aoData,{
                    ...
                    "dataobject": "systemAnalysisActivityTypeEntity",
    ...
    on_addActivityType_click:function(e){
        if(this.systemAnalyseDialog == null){
            this._initActivityTypeDialog();
        }       
        this.systemAnalyseDialog.open();
    },
    /**
     * @title 删除安全信息类型
     * @param e {object} 鼠标对象
    ...
    _initActivityTypeDialog:function(){
        ...
        this.systemAnalyseDialog = new com.sms.common.stdComponentOperate($("div[umid='systemAnalyseDialog']",this.$),{
            "title":com.sms.plugin.riskAnalysis.systemAnalyseActivityType.i18n.addActivityType,
            "dataobject":"systemAnalysisActivityTypeEntity",
            "fields":[
        ...
        this.systemAnalyseDialog.override({
            refreshDataTable:this.proxy(function(){
                this.dataTable.fnDraw();
            })
        });
...
com.sms.plugin.riskAnalysis.systemAnalyseActivityType.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
                                               '../../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.plugin.riskAnalysis.systemAnalyseActivityType.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
