//@ sourceURL=com.sms.plugin.workflow.setSingleUser
$.u.define('com.sms.plugin.workflow.setSingleUser', null, {
    ...
    fillData:function(data){
    	this.selectUser && this.selectUser.select2("data",data);
...
com.sms.plugin.workflow.setSingleUser.widgetjs = ['../../../../uui/widget/select2/js/select2.min.js'];
com.sms.plugin.workflow.setSingleUser.widgetcss = [{id:"",path:"../../../../uui/widget/select2/css/select2.css"},{id:"",path:"../../../../uui/widget/select2/css/select2-bootstrap.css"}];