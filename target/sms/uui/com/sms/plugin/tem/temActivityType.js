//@ sourceURL=com.sms.plugin.tem.temActivityType
$.u.define('com.sms.plugin.tem.temActivityType', null, {
    ...
    afterrender: function (bodystr) {
    	this.i18n = com.sms.plugin.tem.temActivityType.i18n;
    	...
    	this.dataTable = this.qid("datatable").dataTable({
            ...
            "fnServerParams": this.proxy(function (aoData) {
            	$.extend(aoData,{
            		...
            		"dataobject": "temActivityTypeEntity",
    ...
    _initActivityTypeDialog:function(){
    	...
    	this.activityTypeDialog = new com.sms.common.stdComponentOperate($("div[umid='activityTypeDialog']",this.$),{
    		"title":com.sms.plugin.tem.temActivityType.i18n.addActivityType,
    		"dataobject":"temActivityTypeEntity",
    		"fields":[
...
com.sms.plugin.tem.temActivityType.widgetjs = ['../../../../uui/widget/jqdatatable/js/jquery.dataTables.js',
                                               '../../../../uui/widget/jqdatatable/js/dataTables.bootstrap.js'];
com.sms.plugin.tem.temActivityType.widgetcss = [{ path: '../../../../uui/widget/jqdatatable/css/jquery.dataTables.css' },
