//@ sourceURL=com.sms.plugin.render.organizationProp
$.u.define("com.sms.plugin.render.organizationProp", "com.sms.plugin.render.baseprop", {
    // table段
    ...
    read_html: function (setting) {
    	 ...
    	 var unitName=setting.value.name;
         /*$.u.ajax({
  			url : $.u.config.constant.smsqueryserver,
  			type:"post",
  			async:false,
		...
		htmls = htmls.replace(/#\{name\}/g, setting.name || "")
		             .replace(/#\{content\}/g, unitName || "<span class='text-muted'>无</span>")
		 		 	 .replace(/#\{value\}/g, setting.value.id|| "");
		return htmls;
    },
...
com.sms.plugin.render.organizationProp.widgetjs = ['../../../../uui/widget/select2/js/select2.min.js'];
com.sms.plugin.render.organizationProp.widgetcss = [{id:"",path:"../../../../uui/widget/select2/css/select2.css"},
