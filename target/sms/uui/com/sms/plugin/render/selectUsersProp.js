//@ sourceURL=com.sms.plugin.render.selectUsersProp
$.u.define("com.sms.plugin.render.selectUsersProp", "com.sms.plugin.render.baseprop", {
    // table段
    table_html: function (data, type,row) {
    	var result = [];
    	data && $.each(data, function(idx, user){
...
com.sms.plugin.render.selectUsersProp.widgetjs = ['../../../../uui/widget/select2/js/select2.min.js'];
com.sms.plugin.render.selectUsersProp.widgetcss = [{id:"",path:"../../../../uui/widget/select2/css/select2.css"},
