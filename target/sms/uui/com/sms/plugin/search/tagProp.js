//@ sourceURL=com.sms.plugin.search.tagProp
$.u.define("com.sms.plugin.search.tagProp", "com.sms.plugin.search.baseprop",{
    // filter段
    filter_html: function () { 
    	return  '<div class="filter-layer">'
				...
				+ 				'<input type="text" placeholder="查找标签..."  class="form-control input-sm" id="' + this._id + '-search"/>'			
