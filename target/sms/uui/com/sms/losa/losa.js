...
var addLink=function( data){
	  document.getElementById('homePage').href="auditContent.html?id="+data;
	   document.getElementById('basicUrl').href="obserview.html?id="+data;
	  document.getElementById('departUrl').href="../departure/departure.html?id="+data;
	  document.getElementById('takeOffUrl').href="takeOff.html?id="+data;
	  document.getElementById('cruiseUrl').href="cruise.html?id="+data;
	  document.getElementById('techWsUrl').href="techWorkSheet.html?id="+data;
	  document.getElementById('launchUrl').href="launch.html?id="+data; 
	  document.getElementById('wholeFlUrl').href="wholeFlight.html?id="+data;
	  document.getElementById('threatUrl').href="threatWork.html?id="+data;
	  document.getElementById('errorUrl').href="errorWork.html?id="+data;
	  document.getElementById('crewUrl').href="crewInterview.html?id="+data;
	  document.getElementById('appendix').href="appendix.html?id="+data;
};
//添加根节点
