...
$.u.define('com.eiosa.log.eiosaIsarpOperateLog', null, {
	        ...
	        $.u.ajax({
	        	...
	        	if (result.success) {
	                ...
	                $.each(result.data.aaData, this.proxy(function (idx, adata) {
	                    ...
	                    if (adata.detail && adata.detail.length > 0) {
	                        descriptionhtml += "<ul class='updates activity-list'>";
	                        if(adata.receiver!=null){
	                        	descriptionhtml+="<li>" + "发送消息：【"+adata.detail +"】给"+adata.receiver+ "</li>";
	                        }else{
	                        	descriptionhtml+="<li>" + adata.detail + "</li>";
	                        }
...
com.eiosa.log.eiosaIsarpOperateLog.widgetjs = [];
com.eiosa.log.eiosaIsarpOperateLog.widgetcss = [];
