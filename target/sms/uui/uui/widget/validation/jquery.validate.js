...
(function (factory) {
	...
	$.extend($.validator, {
		...
		messages: {
			...
			max: $.validator.format("请输入小于或等于{0}."),
			min: $.validator.format("请输入大于或等于 {0}.")
		},
		...
		attributeRules: function (element) {
			...
			// chrome下attr("maxlength") = '' Number('') 时返回0 mark by: chentao ps: 这是个坑
		...
		methods: {
			...
			// 验证日期和时间是否合法  格式为：yyyy-MM-dd HH:mm:ss
			...
			// 验证小数点后的位数
			decimals : function(value, element, d){  
